...
router.get(
  '/getFriendStatusInfo/:myId/:userId/:status',
  checkHeader,
  userController.getFriendStatusInfo,
);
router.get(
  '/getAllFriendsIfnfo/:id',
  checkHeader,
  userController.getAllFriendsIfnfo,
);
...
router.post(
  '/writeNewUserInChat',
  checkHeader,
  chatController.writeNewUserInChat,
);

router.get(
  '/findChatByUserId/:id',
  checkHeader,
  chatController.findChatByUserId,
);
router.get(
...
router.get(
  '/returnActiveChats/:id',
  checkHeader,
  chatController.returnAllUserChats,
);
